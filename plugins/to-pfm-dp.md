...
Saves the depth info as PFM (portable float map) files with no loss of information. The associated JPG images can be placed in folder relative to the annotation.

```
usage: to-pfm-dp [-h] [-l {DEBUG,INFO,WARNING,ERROR,CRITICAL}]
                 [-N LOGGER_NAME] [--skip]
...
Saves the depth info as PFM (portable float map) files with no loss of
information. The associated JPG images can be placed in folder relative to the
annotation.
