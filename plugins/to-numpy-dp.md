...
Saves the depth info as pickled numpy files with no loss of information. The associated JPG images can be placed in folder relative to the annotation.

```
usage: to-numpy-dp [-h] [-l {DEBUG,INFO,WARNING,ERROR,CRITICAL}]
                   [-N LOGGER_NAME] [--skip]
