...
class ImageData(AnnotationHandler, MetaDataHandler, NameSupporter, SourceSupporter, BytesSupporter, LoggingHandler):
    ...
    def image_bytes(self):
        """
        Turns the pillow image into bytes. Either uses the already stored _data, or loads from _source
        or converts the current image into bytes (writing to memory buffer).
