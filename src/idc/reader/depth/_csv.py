...
class CSVDepthInfoReader(Reader, VariableSupporter):
    ...
    def description(self) -> str:
        ...
        :rtype: str
        """
        return "Loads the depth information from associated CSV files with no header row."
    ...
    def read(self) -> Iterable:
        ...
        annotations = np.loadtxt(self.session.current_input, delimiter=",", dtype=np.float32)
