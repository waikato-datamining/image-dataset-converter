...
from idc.api import ImageSegmentationData, load_image_from_file, imgseg_from_bluechannel, empty_image, \
...
class BlueChannelImageSegmentationReader(Reader, VariableSupporter, AnnotationsOnlyReader):
