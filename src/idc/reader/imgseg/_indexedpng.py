...
from idc.api import ImageSegmentationData, load_image_from_file, imgseg_from_indexedpng, JPEG_EXTENSIONS, empty_image, \
    FORMAT_JPEG, FORMAT_EXTENSIONS, ensure_indexed_palette
