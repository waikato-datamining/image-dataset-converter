...
from idc.api import ImageSegmentationData, locate_file, load_image_from_file, from_grayscale
from idc.api import Reader


class GrayscaleImageSegmentationReader(Reader):
    ...
    def description(self) -> str:
        ...
        :rtype: str
        """
        return "Loads the annotations from associated grayscale PNG files."
    ...
    def read(self) -> Iterable:
        ...
        annotations = from_grayscale(ann, self.labels, self._label_mapping, self.logger(), background=self.background)
