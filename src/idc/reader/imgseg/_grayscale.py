...
from idc.api import ImageSegmentationData, locate_file, load_image_from_file, imgseg_from_grayscale, JPEG_EXTENSIONS
...
class GrayscaleImageSegmentationReader(Reader, PlaceholderSupporter):
    ...
    def read(self) -> Iterable:
        ...
        annotations = imgseg_from_grayscale(ann, self.labels, self._label_mapping, self.logger(), background=self.background)
