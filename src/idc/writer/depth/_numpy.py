...
class NumpyDepthInfoWriter(SplittableStreamWriter, AnnotationsOnlyWriter, InputBasedPlaceholderSupporter):
    ...
    def description(self) -> str:
        ...
        :rtype: str
        """
        return "Saves the depth info as pickled numpy files with no loss of information. The associated JPG images can be placed in folder relative to the annotation."
