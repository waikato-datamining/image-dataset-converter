...
class CSVDepthInfoWriter(SplittableStreamWriter, AnnotationsOnlyWriter, InputBasedPlaceholderSupporter):
    ...
    def description(self) -> str:
        ...
        :rtype: str
        """
        return "Saves the depth info as CSV files with no header rows. The associated JPG images can be placed in folder relative to the annotation."
    ...
    def write_stream(self, data):
        ...
        for item in make_list(data):
            ...
            if item.has_annotation():
                ...
                np.savetxt(path, item.annotation.data, delimiter=",", fmt='%f')
