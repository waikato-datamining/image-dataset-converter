...
filters (69):
   ...
   convert-image-format, copy-files, count-specks, delete-storage, 
   depth-to-grayscale, depth-to-greyscale*, dimension-discarder, 
   dims-to-metadata, discard-by-name, discard-invalid-images, 
   discard-negatives, discard-positives, filter-labels, 
   ...
   log-data, map-labels, max-records, metadata, metadata-from-name, 
   metadata-od, metadata-to-placeholder, move-files, od-to-ic, od-to-is, 
   passthrough, polygon-discarder, polygon-simplifier, pyfunc-filter, 
